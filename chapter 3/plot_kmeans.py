...
pylab.savefig(os.path.join(CHART_DIR, "04_%i.png" %i))
pylab.clf()
...
#c_ was used to concatenate along the second axis.
#sp.c_[sp.array([[1,2,3],[4,5,6]]), sp.array([[0],[1]])]
...
## imshow is very important refer to the manual
c1a, c1b, c1c = km.cluster_centers_
pylab.scatter(km.cluster_centers_[:, 0], km.cluster_centers_[:, 1],
              marker='x', linewidth=2, s=100, color='black')
pylab.savefig(os.path.join(CHART_DIR, "1400_%i.png" % i))
pylab.clf()
